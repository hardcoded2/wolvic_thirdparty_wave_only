 ...
 *
 * @param show: Show or hide passthrough overlay.
 * @param delaySubmit: Delay the return of @ref WVR_SubmitFrame() when the passthrough overlay is showing to improve the latency.
...
*/
extern WVR_EXPORT bool WVR_ShowPassthroughOverlay(bool show, bool delaySubmit = false);
 ...
 * This function must be called after calling @ref WVR_RenderInit().
 *
 * @param Show or hide passthrough underlay.
